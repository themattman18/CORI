...
namespace CORI.Data.Migrations
{
    ...
    [Migration("20180818012229_Testing migration deletion")]
    partial class Testingmigrationdeletion
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CORI.IO.Models.SurveyResult", b =>
                {
                    b.HasOne("CORI.IO.Models.Contact", "ContactId")
                        .WithMany()
                        .HasForeignKey("ContactId1");

                    b.HasOne("CORI.IO.Models.Question", "QuestionId")
                        .WithMany()
            ...
            modelBuilder.Entity("CORI.IO.Models.UserContact", b =>
                {
                    b.HasOne("CORI.IO.Models.ApplicationUser", "ApplicationUserId")
                        .WithMany()

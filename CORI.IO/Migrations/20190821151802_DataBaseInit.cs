        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Contacts_ContactMethods_ContactMethodId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_SurveyResults_Contacts_ContactId",
            ...
            migrationBuilder.InsertData(
                ...
                columns: new[] { "ContactMethodId", "Description" },
                values: new object[,]
                {
                    { 1, "30 Second Survey" },
                    { 2, "Soul Winning" },
            ...
            migrationBuilder.InsertData(
                table: "Questions",
                columns: new[] { "QuestionId", "Description" },
                values: new object[,]
                {
                    { 1, "Which of these is the most important for you to experience during college?" },
                    { 2, "On a scale from 1-10 how important is the spiritual area of your life?" },
                    { 3, "I am interested in hearing more about Driven Student Ministry" }
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Contacts_ContactMethodId",
                table: "Contacts",
                column: "ContactMethodId");

            migrationBuilder.CreateIndex(
                name: "IX_SurveyResults_ContactId",
                table: "SurveyResults",
                column: "ContactId");
